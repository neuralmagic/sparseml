...
from sparseml.deepsparse.benchmark import (
...
def cpu_runner_fixture(
    ...
    return DeepSparseBenchmarkRunner(
        mobilenet_fixture,
        batch_size=32,
        iterations=10,
        warmup_iterations=5,
...
class TestDeepSparseBenchmarkRunner:
    def test_cpu_init(
        ...
        runner = DeepSparseBenchmarkRunner(
            mobilenet_fixture,
        ...
        assert "onnxruntime" not in runner.package_versions
        assert runner.framework_args == framework_args
        assert runner.model == model

    def test_run_batch(self, cpu_runner_fixture: DeepSparseBenchmarkRunner):
    ...
    def test_run(
        ...
        cpu_runner_fixture: DeepSparseBenchmarkRunner,
    ):
    ...
    def test_benchmark_config(self, cpu_runner_fixture: DeepSparseBenchmarkRunner):
