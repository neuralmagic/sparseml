...
def test_ks_loss_sensitivity_analysis():
    ...
    path = os.path.join(tempdir, "ks-sens-analysis.json")
    ...
    path = os.path.join(tempdir, "ks-sens-analysis-integral-normalized.png")
    ...
    path = os.path.join(tempdir, "ks-sens-analysis-integral.png")
    analysis.plot(path, plot_integral=True, normalize=False)
    assert os.path.exists(path)

    path = os.path.join(tempdir, "ks-sens-analysis-avg-normalized.png")
    analysis.plot(path, plot_integral=False)
    assert os.path.exists(path)

    path = os.path.join(tempdir, "ks-sens-analysis-avg.png")
