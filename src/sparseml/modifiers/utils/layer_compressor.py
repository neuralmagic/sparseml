...
from sparseml.modifiers.utils.gpt_helpers import TerminalModuleCompressor
...
class LayerCompressor(ABC):
    ...
    gpt_class: TerminalModuleCompressor
    ...
    def invoke_fasterprune(self, gpts: TerminalModuleCompressor):
        """
        Invoke fasterprune method on the TerminalModuleCompressor object

        :param gpts: Instantiated TerminalModuleCompressor object
