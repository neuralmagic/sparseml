...
class ModuleSparsificationInfo:
    ...
    def __init__(
        ...
        if self.state_dict is not None:
            # when analyzing an FSDP model, the state_dict does not differentiate between
            # trainable and non-trainable parameters (e.g. it can contain buffers)
            # this means that the self.trainable_parameters may be overestimated
