...
class _GMPruningModifier(_PruningParamsModifier, BaseGMPruningModifier):
    """
    ...
    def __init__(
        ...
        super(_GMPruningModifier, self).__init__(
            params=params,
...
@PyTorchModifierYAML()
class LegacyGMPruningModifier(_GMPruningModifier):

    # pointer to old GMPruningModifier during migration for testing,
    # will be deleted with this file
    pass


@PyTorchModifierYAML()
class MovementPruningModifier(_GMPruningModifier):
    """
    Gradually applies kernel sparsity to a given parameter or parameters from
    init_sparsity until final_sparsity is reached over a given amount of time
    and applied with an interpolated function for each step taken.
