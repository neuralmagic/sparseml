"""
Object detection ks (pruning) sensitivity script.
...
##########
Command help:
usage: detection_pruning_loss_sensitivity.py [-h] [--approximate]
...
##########
Example command for running approximated KS sensitivity analysis on ssd300_resnet50:
python scripts/pytorch/detection_pruning_loss_sensitivity.py \
    --approximate --arch-key ssd300_resnet50 --dataset coco \
...
def parse_args():
    ...
    parser.add_argument(
        "--save-dir",
        type=str,
        default="pytorch_detection_pruning_loss_sensitivity",
