...
class RandNDataset(Dataset):
    def __init__(self, length: int, shape: Union[int, Tuple[int, ...]], normalize: bool):
        """
        ...
        self._data = []
        normalize = transforms.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]) if normalize else None
