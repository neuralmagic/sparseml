...
class ImageNetDataset(ImageFolder):
    ...
    def __init__(self, root: str, train: bool = True, rand_trans: bool = False, image_size: int = 224):
        """
        ...
        root = os.path.join(os.path.abspath(os.path.expanduser(root)), 'train' if train else 'val')
