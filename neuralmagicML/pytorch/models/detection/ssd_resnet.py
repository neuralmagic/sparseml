...
from neuralmagicML.pytorch.models.detection import SSDBackbone, SSD300
...
class SSD300ResNetBackbone(SSDBackbone):
    ...
    :param pretrained: True to load pretrained ResNet weights; to load a specific version
        give a string with the name of the version (recal, recal-perf). Default is True
...
@ModelRegistry.register(
    ...
    architecture="ssd-300",
    sub_architecture="resnet-18",
...
def ssd300_resnet18(
    ...
    :param pretrained_backbone: True to load pretrained ResNet weights; to load a
        specific version give a string with the name of the version (recal, recal-perf).
        Default is True
